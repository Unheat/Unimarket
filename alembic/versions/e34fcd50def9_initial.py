...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("customer", "admin", name="user_roles"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["billing_address_id"], ["addresses.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_method",
            sa.Enum("credit_card", "paypal", "bank_transfer", name="payment_method"),
            nullable=False,
        ),
